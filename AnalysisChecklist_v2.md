...
<tr>
    <td>$\textcolor{red}{Update \ this \ section:}$ <br>sample is randomly selected from population<br>Observations are independent<br>data are normally distributed (residuals are normally distributed)<br>homogeneity of variance<br></td>
</tr>
<tr>
    <td>NHST steps:</td>
</tr>
...
<tr>
    <td>$\textcolor{red}{Update \ this \ section:}$ <br>F(df between, df within) = [F-value], p = [p-value]<br><br><br><br></td>
</tr>
<tr>
...
<tr>
    <td>$\textcolor{red}{Update \ this \ section:}$ <br>Describe which post-hoc test(s) you run and your rationale for choosing the test(s).<br><br><br><br></td>
</tr>
<tr>
    <td>What is the effect size? What is the interpretation of the effect size?</td>
</tr>
<tr>
    <td>$\textcolor{red}{Update \ this \ section:}$ <br>partial eta squared (.01-small, .06-medium, .14-large) = <br><br>or omega squared (.06-small, .14-medium, >.14-large) = <br><br></td>
</tr>
<tr>
