...
| <br><br><br><br> |
| **--------------------Section #3: Individual Test Information (one-way ANOVA)--------------------** |
|  |
...
| $\color{red}{Update \ this \ section:}$ <br>H0: There is no difference between group means<br><br>H1: There is a difference between group means<br><br> |
| 2. Establish the criteria for rejection (alpha level). |
| Typically alpha = .05<br><br><br><br> |
| 3. Calculate the test statistic. |
| $\textcolor{red}{Update \ this \ section:}$ <br>F(df between, df within) = [F-value], p = [p-value]<br><br><br><br> |
